...
namespace WordWorld.Creatures
{
    ...
    {
        public static FLabel[] Init(TubeWormGraphics wormGraf, CreatureTemplate.Type type, RoomCamera.SpriteLeaser sLeaser)
        {
        ...
        public static void Draw(TubeWormGraphics wormGraf, FLabel[] labels, RoomCamera.SpriteLeaser sLeaser, float timeStacker, Vector2 camPos)
        {
